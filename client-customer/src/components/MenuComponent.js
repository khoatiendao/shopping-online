...
class Menu extends Component {
      ...
      <div className="border-bottom">
        ...
        <div className="float-right">
          <form className="search">
            <input type="search" placeholder="Enter keyword" className="keyword" value={this.state.txtKeyword} onChange={(e) => {
  ...
  // apis
  apiGetCategories() {
    axios.get('http://localhost:8000/api/customer/categories').then((res) => {
